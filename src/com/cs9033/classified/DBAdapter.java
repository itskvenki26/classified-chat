...
import java.util.List;  
   ...
   public class DBAdapter {
      ...
      // public static final String DEVICE_TABLE = "tbl_device";
       ...
       private static final String[] ALL_TABLES = { USER_TABLE,POSTS_TABLE,COMMENTS_TABLE};
        
       /** Create table syntax */
        
       private static final String USER_CREATE = 
         "create table tbl_user(_id integer primary key autoincrement,  user_email_lid text not null, user_name text not null,user_ph_no text not null);";
       private static final String POSTS_CREATE = 
    	         "create table tbl_user(_id integer primary key autoincrement,  creator text not null, time text not null,message text not null);";
       private static final String COMMENTS_CREATE = 
  	         "create table tbl_user(_id integer primary key autoincrement,  creator text not null, time text not null,message text not null, post_id text not null);";
     ...
     /***** Main Database creation INNER class ******/
      ...
      /* public static void addDeviceData(String DeviceName, String DeviceEmail,
       ...
       public static UserData getUserData(int id) {
           ...
           Cursor cursor = db.query(USER_TABLE, new String[] { KEY_ID,KEY_USER_EMAIL_ID,
                   KEY_USER_NAME, KEY_USER_PH_NO}, KEY_ID + "=?",
       ...
       public static Posts getPostsData(int id) {
           ...
           Cursor cursor = db.query(USER_TABLE, new String[] { KEY_ID,KEY_POST_CREATOR,
        		   KEY_POST_TIME, KEY_POST_MSG}, KEY_ID + "=?",
                   new String[] { String.valueOf(id) }, null, null, null, null);
           if (cursor != null)
               cursor.moveToFirst();
       ...
       public static Comments getCommentsData(int id) {
           ...
           Cursor cursor = db.query(USER_TABLE, new String[] { KEY_ID,KEY_POST_CREATOR,
        		   KEY_POST_TIME, KEY_POST_MSG,KEY_COMMENT_POST_ID}, KEY_ID + "=?",
                   new String[] { String.valueOf(id) }, null, null, null, null);
           if (cursor != null)
               cursor.moveToFirst();
      ...
      /* public static int validateDevice() {
       ...
       public static List<UserData> getDistinctUser() {
           List<UserData> contactList = new ArrayList<UserData>();
           // Select All Query
           String selectQuery = "SELECT  distinct(user_email_id),user_name  FROM " + USER_TABLE+
